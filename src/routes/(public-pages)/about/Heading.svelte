	...
	<div class="flex flex-col items-center w-full relative">
		<a href="/catalog" class="z-10">
			<img
				src={Tomatoes}
				alt="tomato"
				class="sm:h-[15rem] h-[10rem] lg:h-[30rem] w-fit object hover:translate-y-[-5px] hover:translate-x-[-5px] transition-all duration-700"
			/>
		</a>
		<img
			src={Tomatoes}
	...
	<div class="custom-shape-divider-bottom-1692710190">
		...
		>
			<path
				...
				class="fill-[#EF4444] dark:fill-red-700"
			/>
		</svg>
	</div>
</div>
