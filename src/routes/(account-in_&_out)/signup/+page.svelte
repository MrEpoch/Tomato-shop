...
{#if form?.fail}
	<div
		id="alert-2"
		class="flex fixed bottom-0 w-full items-center p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
		role="alert"
	>
		<svg
...
>
	...
	<div
		class={`${
			isLoading ? 'hidden' : ''
		} flex flex-col h-full w-full gap-[3rem] justify-center items-center`}
	>
