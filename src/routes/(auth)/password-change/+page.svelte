...
>
	...
	<form
		class="max-w-[500px] dark:bg-black/20 w-full shadow bg-white mb-[5rem] relative rounded p-[2rem] sm:p-[5rem] flex flex-col gap-[3rem]"
		method="POST"
	>
		<svg
			xmlns="http://www.w3.org/2000/svg"
			class="absolute top-0 dark:text-white/80 left-0 translate-y-[-50px] translate-x-[10px] w-[70px] sm:w-[100px]"
			viewBox="0 0 24 24"
			><title>Secure</title><path
				fill="currentColor"
		...
		<div class="flex justify-center">
			<button
				type="submit"
				class="py-2 p-8 rounded-[6px] bg-black text-white font-light text-sm sm:text-lg hover:bg-gray-800 transition-all"
