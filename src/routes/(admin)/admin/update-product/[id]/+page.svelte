...
<div class="w-full min-h-screen flex flex-col bg-black/10">
    ...
    {/if}
    <form method="POST" enctype="multipart/form-data" action={`?/${update ? 'update' : 'delete'}`}
        ...
        <div class="flex justify-center gap-[2rem]">
            <button class="py-2 px-6 hover:bg-red-700 bg-red-600 rounded-xl font-bold leading-normal">Delete Product</button>
            <button on:click={() => update = true} class="py-2 px-6 hover:bg-blue-700 bg-blue-600 rounded-xl font-bold leading-normal">Update Product</button>
        </div>
    </form>
</div>
