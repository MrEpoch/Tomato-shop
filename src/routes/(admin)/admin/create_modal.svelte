...
<button on:click={openModal} class="w-full rounded-3xl sm:min-w-[250px] sm:max-w-[250px] sm:max-h-[250px] sm:min-h-[250px]  min-w-[200px] max-w-[200px] max-h-[200px] min-h-[200px] flex items-center justify-center from-red-300 to-rose-900  bg-gradient-to-br hover:scale-105 duration-500 cursor-pointer transition-transform">
