        ...
        <div class="relative scroll-element-modal overflow-y-auto w-full max-w-2xl h-full">
            <form method="POST" on:submit|preventDefault={updateMode ? handleUpdate : handleDelete} enctype="multipart/form-data" action={`?/${updateMode ? "update" : "delete"}`} class="relative   bg-white rounded-lg shadow  dark:bg-gray-700">
                ...
                <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                    ...
                    <button on:click={() => hidden = true} type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="staticModal">
                ...
                <div class="flex items-center justify-between p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button disabled={updateMode} data-modal-hide="staticModal" type="submit" class="bg-red-600 rounded-lg py-2 px-5">
                        <svg class="w-6 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>trash-can-outline</title><path fill="currentColor" d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z" /></svg>
                    </button>
                </div>
            </form>
        </div>
