...
{#if !hidden}
	<div in:fly={{ y: 50, duration: 300 }} out:fly={{ y: 0, duration: 300 }}
	...
	>
		<ul class="flex flex-col w-full p-4 md:p-0 mt-4 gap-[3rem] items-center">
			<li class="w-full flex">
				<a data-sveltekit-preload-data href="/about" class="text-xl text-center w-full font-light">About</a>
			</li>
			<li class="w-full flex">
				<a href="/contact" class="text-xl w-full text-center font-light">Contact</a>
			</li>
			<li class="w-full flex">
                <a data-sveltekit-preload-data href="/catalog" class="text-xl text-center w-full mb-3 font-light">Catalog</a>
			</li>
            <li class="w-full flex">
                <button on:click={showCart} class="text-xl flex justify-center text-center w-full mb-3 font-light">
            ...
            <li class="w-full flex">
                <button on:click={handleTheme} class="text-xl flex justify-center text-center w-full mb-3 font-light">
                    <svg class="w-8 md:w-10 dark:text-white/90" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        ><title>Theme Change</title><path
                            fill="currentColor"
                            d="M12,18C11.11,18 10.26,17.8 9.5,17.45C11.56,16.5 13,14.42 13,12C13,9.58 11.56,7.5 9.5,6.55C10.26,6.2 11.11,6 12,6A6,6 0 0,1 18,12A6,6 0 0,1 12,18M20,8.69V4H15.31L12,0.69L8.69,4H4V8.69L0.69,12L4,15.31V20H8.69L12,23.31L15.31,20H20V15.31L23.31,12L20,8.69Z"
