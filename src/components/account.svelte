...
{#if shown}
    <button class="fixed min-h-screen w-screen top-0 left-0 z-5 cursor-default bg-black/50" on:click={handleClick}></button>
            ...
            <div class="flex flex-col">
                <div class="flex flex-row justify-between">
                    <div class="flex flex-col">
                        ...
                        {/if}
                        <a href="/account" on:click={handleClick} class="flex justify-between cursor-pointer dark:text-white/90 hover:bg-gray-500/10 z-10 bg-gray-500/5 p-5 w-full text-gray-700 font-semibold gap-[1rem] transition-all duration-300">
                            <span>Settings</span>
