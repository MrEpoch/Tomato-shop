...
export async function handle_storage_errors(error, handler?: any) {
    switch (error.code) {
        ...
        case 'storage/retry-limit-exceeded':
            console.log('The maximum time limit on an operation (upload, download, delete, etc.) has been exceeded.');
            handler(error.code);
            break;
        case 'storage/invalid-checksum':
            console.log('File on the client does not match the checksum of the file received by the server.');
            handler(error.code);
            break;
        ...
        case 'storage/invalid-argument':
            console.log('An invalid argument was provided. Check function call and make sure the provided arguments match the function signature.');
            handler(error.code);
            break;
